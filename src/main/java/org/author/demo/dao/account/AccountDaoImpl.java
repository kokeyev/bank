...
public class AccountDaoImpl implements AccountDao {
  ...
  public Optional<Account> getAccountById(Long accountId) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить счет", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public Optional<Account> getAccountByCardNumber(String cardNumber) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить счет по номеру карты", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  private Optional<Account> getSingleUserAccount(Long userId, String sql) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить активный счет пользователя", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public List<Account> getAccountsByUserId(Long userId) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить счета пользователя", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public List<Account> getAccountsByStatus(AccountStatus status) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить счета по статусу", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public long countAccountsByUserIdAndStatus(Long userId, AccountStatus status) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось посчитать счета пользователя", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public boolean updateTransactionLimit(Long accountId, BigDecimal transactionLimit) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось изменить лимит счета", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public boolean clearMainAccount(Long userId) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось сбросить основной счет", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public boolean setMainAccount(Long accountId) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось сделать счет основным", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
