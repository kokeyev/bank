...
public class LoanTypeDaoImpl implements LoanTypeDao {
  ...
  public Optional<LoanType> getLoanTypeById(Long loanTypeId) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить тип кредита", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public List<LoanType> getAllLoanTypes() {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось получить типы кредитов", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
  ...
  public boolean changeRateOfLoanType(Long loanTypeId, BigDecimal newRate) {
    ...
    try {
      ...
      throw new RuntimeException("Не удалось изменить ставку типа кредита", e);
    } finally {
      connectionPool.releaseConnection(connection);
    }
  }
